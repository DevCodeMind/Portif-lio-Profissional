...
const PAINEL_DADOS = {
  saude: {
    ...
    opcoes: [
      { label: "Psicologia / consultório", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/psicologa-landing/index.html", icon: "🧠" },
      { label: "Odontologia / dentista", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/odontologia-landing/index.html", icon: "🦷" },
      { label: "Nutrição", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/nutricao-landing/index.html", icon: "🥗" },
      { label: "Clínica / agenda médica", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/clinica-landing/index.html", icon: "🏥" },
    ],
  },
  fitness: {
  ...
  beleza: {
    ...
    opcoes: [
      { label: "Salão de Beleza", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/beleza-landing/index.html", icon: "💅" },
      { label: "Barbearia", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/barbearia-landing/index.html", icon: "✂️" },
    ],
  },
  servicos: {
    ...
    opcoes: [
      { label: "Oficina Mecânica", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/oficina-landing/index.html", icon: "🔧" },
      { label: "Advocacia / jurídico", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/advogado-landing/index.html", icon: "⚖️" },
    ],
  },
  proximo: {
  ...
  nichos: {
    ...
    opcoes: [
      { label: "Jurídico / advogado", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/advogado-landing/index.html", icon: "⚖️" },
      { label: "Fitness / personal trainer", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/personal-landing/index.html", icon: "💪" },
      { label: "Beleza / estética", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/beleza-landing/index.html", icon: "💅" },
      { label: "Serviços locais (oficina, barbearia…)", href: "https://DevCodeMind.github.io/Portif-lio-Profissional/projetos/oficina-landing/index.html", icon: "🔧" },
    ],
  },
};
